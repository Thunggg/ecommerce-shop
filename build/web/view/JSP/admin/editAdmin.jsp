...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="/admin/editAdmin" method="POST" enctype="multipart/form-data" class="product-form" id="productForm">
                <input type="hidden" name="userId" value="${currentUser.id}">  <!-- Thêm thuộc tính ẩn cho ID sản phẩm -->
                <div class="image-section">
                    ...
                    <div class="main-image" onclick="handleImageUpload(this)">
                        ...
                        <img id="mainImagePreview" src="/${currentUser.avatar}" alt="Preview" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;" />
                    </div>
                ...
                <div class="details-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="firstName" id="firstName" placeholder="Enter first name" value="${currentUser.firstName}"/>
                    </div>

                    <!-- Last Name -->
                    <div class="form-group">
                        <label for="lastName">Last Name</label>
                        <input type="text" name="lastName" id="lastName" placeholder="Enter last name" value="${currentUser.lastName}"/>
                    </div>

                    <!-- Email -->
                    <div class="form-group">
                        <label for="Email">Email</label>
                        <input type="text" name="Email" id="Email" placeholder="Enter email" value="${currentUser.email}"/>
                    </div>

                    <!-- Username -->
                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" name="username" id="username" placeholder="Enter username" value="${currentUser.userName}"/>
                    </div>

                    <!-- Password -->
                    <div class="form-group">
                        <label for="password">Password</label>
                        <input type="text" name="password" id="password" placeholder="Enter password" value="${currentUser.password}"/>
                    </div>

                    <!-- Address -->
                    <div class="form-group">
                        <label for="address">Address</label>
                        <input type="text" name="address" id="address" placeholder="Enter address" value="${currentUser.address}"/>
                    </div>

                    <!-- Phone -->
                    <div class="form-group">
                        <label for="phone">Phone</label>
                        <input type="text" name="phone" id="phone" placeholder="Enter phone number" value="${currentUser.phone}"/>
                    </div>
