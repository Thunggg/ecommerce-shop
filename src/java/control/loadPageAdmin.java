 ...
 */
@WebServlet(name = "loadPageAdmin", urlPatterns = {"/admin/loadPageAdmin"})
public class loadPageAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet loadPageAdmin</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet loadPageAdmin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //B1: lay data tu dao
        DAO dao = new DAO();
        ArrayList<user> listUser = dao.getAllAdmin();
        for (user x : listUser) {
        ...
        ArrayList<user> listPagingProduct = dao.pagingAdmin(index);
